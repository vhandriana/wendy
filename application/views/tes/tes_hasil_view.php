...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                            <div class="box-title">Perolehan Nilai</div>
                    </div>

                    <div class="box-body">
                        <table id="table-group" class="table table-bordered table-hover text-center">
                            <thead class="thead-dark">
                                <tr>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">No.</th>                                    
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">Nama Lowongan</th>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">Posisi</th>
                                    <th rowspan="2" style="vertical-align : middle;text-align:center;">Nama User</th>
                                    <th colspan="3" style="vertical-align : middle;text-align:center;">Core Factor</th>
                            ...
                            <tfoot>
                                <th colspan="4" style="vertical-align : middle;text-align:center;">Nilai Ideal</th>
                                <th>Nilai Ideal</th>
                                <th>Nilai Ideal</th>
                                <th>Nilai Ideal</th>
                                <th>Nilai Ideal</th>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                            <div class="box-title">Pemetaan Nilai GAP</div>
                    </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                            <div class="box-title">Pembobotan Nilai GAP</div>
                    </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                            <div class="box-title">Nilai Akhir</div>
                            <div class="box-tools pull-right">
                                <div class="dropdown pull-right">
                                    <a style="cursor: pointer;" onclick="">Print Nilai Akhir</a>
                                </div>
                            </div>
                    </div>
