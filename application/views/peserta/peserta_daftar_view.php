...
<section class="content">
	<div class="row">
        <div class="col-md-3">
                <div class="box">
                    <div class="box-header with-border">
                        <div class="box-title">Pilih Posisi</div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-footer">
                        <p>Pilih posisi terlebih dahulu untuk menampilkan dan menambah data Peserta</p>
                    </div>
                </div>
        </div>
        ...
        <div class="col-md-9">
                <div class="box">
                    <div class="box-header with-border">
    						<div class="box-title">Daftar Peserta Yang Melamar</div>
