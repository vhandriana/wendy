                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tambah-lowongan" name="tambah-lowongan" placeholder="Nama Lowongan">
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tambah-pendidikan" name="tambah-pendidikan" placeholder="Pendidikan">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tambah-jk" name="tambah-jk" placeholder="Jenis Kelamin">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Umur Minimal</label>
                                        <input type="text" class="form-control" id="tambah-umurMin" name="tambah-umurMin" placeholder="Umur Minimal">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tambah-umurMax" name="tambah-umurMax" placeholder="Umur Maksimal">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Tinggi Badan</label>
                                        <input type="text" class="form-control" id="tambah-tb" name="tambah-tb" placeholder="Tinggi Badan">
                                    </div>
                                </div>
