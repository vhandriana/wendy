...
class Tes_dashboard extends Tes_Controller {
    ...
    function get_datatable(){
		...
		$lowongan_id = $this->cbt_user_grup_model->get_by_kolom_limit('posisi', $group, 1)->row()->lowongan_id;
		$username = $this->access_tes->get_username();
		$user_id = $this->cbt_user_model->get_by_kolom_limit('user_name', $username, 1)->row()->user_id;
		...
		$query = $this->cbt_tesgrup_model->get_datatable($start, $rows, $lowongan_id);
		$iFilteredTotal = $query->num_rows();
		
		$iTotal= $this->cbt_tesgrup_model->get_datatable_count($lowongan_id)->row()->hasil;
